...
void Menu::initialOptions(){
	...
	cout << "|     2 - Start Simulation (Multiple Cars/Exac)    |" << endl;
	cout << "|     3 - Start Simulation (Multiple Cars/Aprox)    |" << endl;
	cout << "|     4 - Exit                                |" << endl;
	cout << "|                                             |" << endl;
	cout << "+---------------------------------------------+" << endl;
	...
	switch(opcao){
		case 1:
			...
			break;
		case 2:
			this->calculatePaths_cars_exat();
			break;
		case 3:
			this->calculatePaths_cars_aprox();
			break;
		case 4:
			this->terminate = true;
...
void Menu::calculatePaths_cars_aprox(){
...
//Pseudo Codigo do algoritmo
	...
	cout << "\nIndique o nome da rua onde se encontra: ";
	cin >> street_source;
	cout << "\nIndique o nome da rua onde se quer dirigir: ";
	cin >> street_dest;

	bool source_exists = true, dest_exists = true;

	for(int i = 0; i < m.roads.size(); i++){
		m.compareStringsExac(street_source, m.roads.at(i)->name);
	}
...
void Menu::calculatePaths_cars_exat(){
	//auto start = std::chrono::high_resolution_clock::now();
